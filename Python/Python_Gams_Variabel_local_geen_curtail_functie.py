## running gams files from Variabel_inclusief_local_realistisch_geen_curtail
import gams
import os
...
def init():
    ...
    t1 = ws.add_job_from_file("Variabel_inclusief_local_realistisch_geen_curtail.gms")
    t1.run()
def run():
