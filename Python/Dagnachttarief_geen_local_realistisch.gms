...
*alle temperaturen zijn ingevoerd in kelvin
;
...
ti2eq(t)                 start of part 2 of the load curve
ti3eq(t)                 start of part 3 of the load curve
ti4eq(t)                 start of part 4 of the load curve
...
;
yeq..                    y =e= z/1000000;
zeq ..                   z =e= sum(t,P_conv(t)*price(t));
balance(t) ..            P_conv(t) =e= P_cat1(t)+P_cat2(t)+P_cat3(t)+P_cat4(t);
